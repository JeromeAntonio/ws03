...
class ListingsController
{
    ...
    public function store()
    {
        ...
        $requiredFields = ['salary', 'title', 'description', 'email', 'city', 'state'];
    ...
    public function destroy($params)
    {
        ...
        if (!Authorization::isOwner($listing['user_id'])) {
            ...
            redirect('/listings/listing/' . $listing['id']);
    ...
    //search listing by keyword/locale_get_region
